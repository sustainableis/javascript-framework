...
(function(angular) {
   ...
   * and serializes post payload objects
   */
  angular.module('sis.api').factory('authInterceptor', ['$q', 'sisConfiguration',
    function($q,
      sisConfiguration) {
      return {
   ...
   */
  angular.module('sis.api').config(['$httpProvider', '$logProvider', 'sisConfigurationProvider',
   ...
   */
  angular.module('sis.modules').config(['$sceDelegateProvider', 'path',
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('BuildingsService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular, _) {
  ...
  angular.module('sis.modules').provider('dataStore', function() {
    ...
    this.$get = ['$injector', '$log', 'OauthService', 'FacilitiesService', 'OrganizationsService', 'BuildingsService', 'FeedsService', 'OutputsService', 'UsersService', 'WeatherService',
      function($injector, $log, OauthService, FacilitiesService,
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('FacilitiesService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   *  - /v1/feeds/types
   */
  angular.module('sis.api').factory('FeedsService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular, events, _, $) {
  ...
  angular.module('sis.modules').provider('sisModules', function() {
    ...
    this.$get = ['$injector', '$q', '$log', 'dataStore', 'ModulesService',
      function($injector, $q, $log, dataStore, ModulesService) {
        var _this = this;
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('ModulesService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   *  - /oauth/token
   */
  angular.module('sis.api').factory('OauthService', ['$resource', 'url',
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('OrganizationsService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   *  - /v1/outputs/types
   */
  angular.module('sis.api').factory('OutputsService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('UsersService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('UtilitiesService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('ViewsService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('WeatherService', ['$resource', 'url', 'version',
    function($resource,
      url, version) {
