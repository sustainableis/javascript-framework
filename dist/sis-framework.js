...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('EmailsService', ['$resource', 'sisApi', function($resource, sisApi) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('MandrillService', ['$resource', 'sisApi', function($resource, sisApi) {
...
(function(angular) {
   ...
   */
  angular.module('sis.api').factory('StacksService', ['$resource', 'sisApi', function($resource, sisApi) {
